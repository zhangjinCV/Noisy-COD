...
def main():
    ...
    parser.add_argument('--top_lr', type=float, default=4e-4, help='learning rate')
    parser.add_argument('--init_lr', type=float, default=4e-7, help='learning rate')
    parser.add_argument('--min_lr', type=float, default=4e-7, help='learning rate')
    ...
    parser.add_argument('--weak_train_root', type=str, default='/mnt/jixie16t/zj/zj/from_2t_disk/res/step1/norm/CAMO_COD_generate_', help='the training rgb images root')
